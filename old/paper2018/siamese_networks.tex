...
\begin{figure}[htb]
    \subfloat[Triplet loss\label{schroff_loss}]{%
        \includegraphics[width=.3\linewidth]{schroff_triplet}
     }
    ~ 
    \subfloat[Triplet loss\label{modified_loss}]{%
        \includegraphics[width=.3\linewidth]{modified_loss}
     }
    ~ 
    \subfloat[Triplet loss\label{angular_loss}]{%
        \includegraphics[width=.3\linewidth]{angular_loss}
     }
\end{figure}
