...
\begin{figure}[htb]
    \subfloat[Recall rate as a function of neighborhood size\label{people_recall}]{% 
        \includegraphics[width=.5\linewidth]{people_recall}
    }
    ~ 
    \subfloat[Mean negative distance as a function of neighborhood size\label{modified_loss}]{%
        \includegraphics[width=.5\linewidth]{people_distances}
     }
...
\begin{figure}[htb]
   \subfloat[Recall rate as a function of neighborhood size\label{company_recall}]{%
        \includegraphics[width=.5\linewidth]{company_recall}
   }
   ~
   \subfloat[Mean negative distance from anchor as a function of neighborhood size \label{modified_loss}]{%
        \includegraphics[width=.5\linewidth]{company_distances}
   }
