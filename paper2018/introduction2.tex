...
different surface forms for the same entity  For instance, the name of a person might be represented as \textit{Douglas Adams} and \textit{Douglas Noel Adams} or \textit{John Adams} and \textit{Adams, John}, as shown in Table~\ref{table-example}.  Similarly, ontology alignment can require recognizing distinct surface forms of
